...
- API version: 1.16
  - Build date: 2022-02-10T02:06:06.978Z[GMT]
...
<img src="https://github.com/dishant9397/BSDS/blob/master/Week-4-Client/res/Wall%20Time%20(in%20ms)%20vs.%20Number%20of%20Threads.png" height="50%" width="50%"/>

From the above image, we can see that with the increase in the number of threads, the wall time to execute the entire program is decreasing and this is happening because we have overlapping threads and much of the threads would still be in queue before the rest of them are reached.
